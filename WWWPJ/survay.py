class Survey:
    def show(a,b=[]):
        ...
        print('┌───────────────────┐')
        print(' 정보가 마음에 드셨나요? ')
        print('\033[35m'+' 1.만족 2.보통 3.불만족'+'\033[0m')
        print('└───────────────────┘')
        print('　 　ᕱ ᕱ  ||')
        print('　  ( ･ω･ ||')
        print('　  /　つΦ')
        ...
        if(survery_menu == 1):              #만약 1. 만족을 선택하였다면
            ...
            print(result)
            import WWWPJ.survay                     # survay 파일로 임폴트 하자
        ...
        result = f'평균 답변 : {res}'         #res를 출력해주자

        print()                   #색추가
        if 1 <= res <= 1.5:                 #만약 점수가 1에서 1.5점 이라면
            print("평균 답변 :"+'\033[93m'+"★★★★★"+'\033[0m')     #별 5점
        elif 1.5 < res <= 2.0:              #만약 점수가 1.6에서 2.0점 이라면
            print("평균 답변 :"+'\033[93m'+"★★★★☆"+'\033[0m')     #별 4점
        elif 2.0 < res <= 2.5:              #만약 점수가 2.1에서 2.5점 이라면
            print("평균 답변 :"+'\033[93m'+"★★★☆☆"+'\033[0m')     #별 3점
        elif 2.5 < res <= 2.9:              #만약 점수가 2.6에서 2.9점 이라면
            print("평균 답변 :"+'\033[93m'+"★★☆☆☆"+'\033[0m')     #별 2점
        elif res == 3:                      #만약 점수가 3점이라면
            print("평균 답변 :"+'\033[93m'+" ★☆☆☆☆"+'\033[0m')     #별 1점
        print()